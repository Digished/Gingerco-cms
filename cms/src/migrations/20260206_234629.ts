...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  // Clean up any existing tables/types from old schema or failed migration attempts
  await db.execute(sql`
   ...
   DROP TABLE IF EXISTS "_events_v_version_sessions" CASCADE;
   DROP TABLE IF EXISTS "events_sessions" CASCADE;
   ...
   DROP TABLE IF EXISTS "_pages_v_blocks_events_list" CASCADE;
   DROP TABLE IF EXISTS "_pages_v_blocks_content" CASCADE;
   DROP TABLE IF EXISTS "_pages_v_blocks_hero" CASCADE;
   DROP TABLE IF EXISTS "_pages_v_blocks_hero_links" CASCADE;
   ...
   DROP TABLE IF EXISTS "pages_blocks_events_list" CASCADE;
   ...
   DROP TYPE IF EXISTS "public"."enum_pages_blocks_content_layout";
   DROP TYPE IF EXISTS "public"."enum_pages_blocks_events_list_filter_by_type";
   DROP TYPE IF EXISTS "public"."enum_pages_blocks_events_list_layout";
   DROP TYPE IF EXISTS "public"."enum_pages_blocks_gallery_columns";
   DROP TYPE IF EXISTS "public"."enum_pages_blocks_cta_links_style";
   DROP TYPE IF EXISTS "public"."enum_pages_status";
   DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_hero_links_style";
   DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_content_layout";
   DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_events_list_filter_by_type";
   DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_events_list_layout";
   DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_gallery_columns";
   DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_cta_links_style";
   ...
   DROP TYPE IF EXISTS "public"."enum_events_recurrence_pattern";
   ...
   DROP TYPE IF EXISTS "public"."enum__events_v_version_recurrence_pattern";
   DROP TYPE IF EXISTS "public"."enum__events_v_version_currency";
  ...
  CREATE TYPE "public"."enum_pages_blocks_hero_links_style" AS ENUM('primary', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_content_layout" AS ENUM('full', 'two-column', 'text-image', 'image-text');
  CREATE TYPE "public"."enum_pages_blocks_events_list_filter_by_type" AS ENUM('all', 'class', 'workshop', 'event', 'performance');
  CREATE TYPE "public"."enum_pages_blocks_events_list_layout" AS ENUM('grid', 'list');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_hero_links_style" AS ENUM('primary', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_content_layout" AS ENUM('full', 'two-column', 'text-image', 'image-text');
  CREATE TYPE "public"."enum__pages_v_blocks_events_list_filter_by_type" AS ENUM('all', 'class', 'workshop', 'event', 'performance');
  CREATE TYPE "public"."enum__pages_v_blocks_events_list_layout" AS ENUM('grid', 'list');
  ...
  CREATE TYPE "public"."enum_events_event_type" AS ENUM('class', 'workshop', 'event', 'performance');
  CREATE TYPE "public"."enum_events_recurrence_pattern" AS ENUM('weekly', 'biweekly', 'monthly');
  CREATE TYPE "public"."enum_events_currency" AS ENUM('EUR', 'USD');
  CREATE TYPE "public"."enum__events_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__events_v_version_event_type" AS ENUM('class', 'workshop', 'event', 'performance');
  CREATE TYPE "public"."enum__events_v_version_recurrence_pattern" AS ENUM('weekly', 'biweekly', 'monthly');
  CREATE TYPE "public"."enum__events_v_version_currency" AS ENUM('EUR', 'USD');
  CREATE TYPE "public"."enum_forms_confirmation_type" AS ENUM('message', 'redirect');
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('page', 'custom');
  CREATE TYPE "public"."enum_footer_columns_links_link_type" AS ENUM('page', 'custom');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('instagram', 'facebook', 'tiktok', 'youtube', 'twitter');
  ...
  CREATE TABLE "pages_blocks_content" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"layout" "enum_pages_blocks_content_layout" DEFAULT 'full',
  	"rich_text" jsonb,
  	"image_id" integer,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_events_list" (
  	...
  	"filter_by_type" "enum_pages_blocks_events_list_filter_by_type" DEFAULT 'all',
  	"layout" "enum_pages_blocks_events_list_layout" DEFAULT 'grid',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_content" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"layout" "enum__pages_v_blocks_content_layout" DEFAULT 'full',
  	"rich_text" jsonb,
  	"image_id" integer,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE "_pages_v_blocks_events_list" (
  	...
  	"heading" varchar DEFAULT 'Upcoming Events',
  	"show_count" numeric DEFAULT 6,
  	"filter_by_type" "enum__pages_v_blocks_events_list_filter_by_type" DEFAULT 'all',
  	"layout" "enum__pages_v_blocks_events_list_layout" DEFAULT 'grid',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "events" (
  	...
  	"recurrence_pattern" "enum_events_recurrence_pattern",
  	"location" varchar,
  	"address" varchar,
  	"price" numeric,
  ...
  CREATE TABLE "_events_v" (
  	...
  	"version_recurrence_pattern" "enum__events_v_version_recurrence_pattern",
  	"version_location" varchar,
  	"version_address" varchar,
  	"version_price" numeric,
  	"version_currency" "enum__events_v_version_currency" DEFAULT 'EUR',
  ...
  CREATE TABLE "footer_columns_links" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar NOT NULL,
  	"link_type" "enum_footer_columns_links_link_type" DEFAULT 'page',
  	"page_id" integer,
  	"url" varchar
  );
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"copyright" varchar DEFAULT 'Ginger & Co. All rights reserved.',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_events_list_filter_by_type";
  DROP TYPE "public"."enum_pages_blocks_events_list_layout";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_events_list_filter_by_type";
  DROP TYPE "public"."enum__pages_v_blocks_events_list_layout";
  ...
  DROP TYPE "public"."enum_events_recurrence_pattern";
  DROP TYPE "public"."enum_events_currency";
  DROP TYPE "public"."enum__events_v_version_status";
  DROP TYPE "public"."enum__events_v_version_event_type";
  DROP TYPE "public"."enum__events_v_version_recurrence_pattern";
